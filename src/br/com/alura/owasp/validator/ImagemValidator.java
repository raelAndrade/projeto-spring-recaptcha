...
public class ImagemValidator {
	...
	public boolean tratarImagem(MultipartFile imagem, Usuario usuario, HttpServletRequest request) throws IllegalStateException, IOException {
        ...
        /**
         * O método guessContentTypeFromStream irá analisar os bytes que compõem o arquivo, conforme especificado na resposta. 
         * Dessa forma, não importa se o usuário alterar a extensão do arquivo que a validação continuará a ser feita do conteúdo.
         */
