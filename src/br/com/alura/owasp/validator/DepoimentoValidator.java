...
public class DepoimentoValidator implements Validator {
	...
	/* 
	 * Recebe como argumento a classe do objeto que está querendo ser validado e 
	 * retorna se o validador consegue lidar com a validação dos objetos dessa classe.
	 */
	@Override
